# -*- coding: utf-8 -*-
#
# microdrop documentation build configuration file, created by
...
project = 'microdrop'
copyright = '2016, Christian Fobel and Ryan Fobel'
...
htmlhelp_basename = 'microdropdoc'
...
latex_documents = [
    (master_doc, 'microdrop.tex', 'microdrop Documentation',
     'Christian Fobel', 'manual'),
]
...
man_pages = [
    (master_doc, 'microdrop', 'microdrop Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'microdrop', 'microdrop Documentation',
     author, 'microdrop', 'One line description of project.',
     'Miscellaneous'),
]
